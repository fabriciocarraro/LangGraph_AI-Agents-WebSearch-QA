...
Your answer MUST be technical, using up to date information. Cite facts, data and specific informations.
...
The specific search query was:
<SEARCH_QUERY>
{search_query}
</SEARCH_QUERY>

And here's the web search results:
<SEARCH_RESULTS>
{search_results}
</SEARCH_RESULTS>
"""
